...
const AddEditNotes = ({noteData, type, getAllNotes, onClose, showToastMessage}) => {
    ...
    const addNewNote = async ()=>{
      try {
        const response = await axiosInstance.post("http://localhost:8000/api/auth/add-note",{
          title, 
          content,
          tags,
        })
    ...
    const editNote = async ()=>{
      ...
      try {
        const response = await axiosInstance.put("http://localhost:8000/api/auth/edit-note/" + noteId ,{
          title, 
          content,
          tags,
        })
    ...
    <div className='relative'>
      ...
      <div className='flex flex-col gap-2 '> 
        ...
        <input type='text'
            ...
            placeholder='Workout Everyday @7'
            value={title}
